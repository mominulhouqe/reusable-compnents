...
const NormalForm = () => {
  ...
  return (
    <form
      ...
      className={cn("border border-gray-300 max-w-md mx-auto mt-12 p-4 shadow-sm" , {
        "max-w-5xl": double,
        "max-w-md": !double,
      })}
    >
      <div
        className={cn(
          "p-2 grid grid-cols-1 justify-items-center gap-2",
          {
      ...
      <div
        className={cn(
          "p-2 grid grid-cols-1 justify-items-center gap-5",
          {
            "md:grid-cols-2 ": double,
          }
        )}
